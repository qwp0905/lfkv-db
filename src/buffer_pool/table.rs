...
//   let mut pins = Vec::with_capacity(cap);
//   pins.resize_with(cap, Default::default);

//   let mut pairs = Vec::new();
//   for i in 0..16 {
//     let guard = table.asdf(i, &pins).unwrap_err();
...
//     assert_eq!(pins[*frame_id].load(Ordering::Acquire), 1);
//   }
// }
